        ...
        <div className="min-h-screen bg-gray-50 py-12 px-6">
            <div className="max-w-6xl mx-auto">
                ...
                <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
                    We are dedicated to making online shopping easy, affordable, and enjoyable.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-20">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            ShopEase started with a simple mission: to provide high-quality products at
                            fair prices, delivered straight to your doorstep. We’ve grown into a brand that
                            values trust, quality, and customer satisfaction above everything else.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                    <div className="order-2 md:order-1">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            From electronics to groceries and daily essentials, we bring you a curated
                            shopping experience. Our service includes easy payments, secure checkout,
                            fast shipping, and great customer support.
                        </p>
                    </div>
                    <img
                        src="../../src/assets/what2.png"
                        alt="Service"
                ...
                <div className="mb-20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            />
                            <h3 className="text-lg font-semibold text-gray-800">Muni Neelam</h3>
                        ...
                        <div className="flex flex-col items-center text-center">
                            <img
                                ...
                                className="w-28 h-28 rounded-full object-cover mb-3 shadow-md"
                            />
                            <h3 className="text-lg font-semibold text-gray-800">Priya Verma</h3>
                        ...
                        <div className="flex flex-col items-center text-center">
                            <img
                                ...
                                className="w-28 h-28 rounded-full object-cover mb-3 shadow-md"
                            />
                            <h3 className="text-lg font-semibold text-gray-800">Ajay Kumar</h3>
